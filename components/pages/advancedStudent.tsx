...
const EnhancedStudentTable = () => {
  ...
  const getStatusColor = (status: string = 'active') => {
    const colors: Record<string, string> = {
      ...
      'graduated': 'bg-red-100 text-gray-800 hover:bg-red-100',
      ...
      <Card className="w-full border-none shadow-none">
        ...
        <CardContent className="p-0">
          ...
          <div className="mb-6 grid grid-cols-2 gap-4 md:grid-cols-4 lg:grid-cols-6">
            <Card className="col-span-2 md:col-span-1 rounded-2xl border-zinc-200 bg-gradient-to-br from-white to-zinc-50 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md">
            ...
            <Card className="col-span-2 md:col-span-1 rounded-2xl border-zinc-200 bg-gradient-to-br from-white to-zinc-50 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md">
              <CardContent className="p-5">
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    <span className="text-sm font-medium text-zinc-500">Avg Attendance</span>
                  ...
                  <Progress value={stats.averageAttendance} className="h-2 rounded-full" />
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="col-span-2 md:col-span-1 rounded-2xl border-zinc-200 bg-gradient-to-br from-white to-zinc-50 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md">
              <CardContent className="p-5">
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    <span className="text-sm font-medium text-zinc-500">Avg Performance</span>
                    <span className="flex h-10 w-10 items-center justify-center rounded-2xl bg-red-100 text-gray-700">
                  ...
                  <Progress value={stats.averagePerformance} className="h-2 rounded-full" />
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="col-span-2 md:col-span-1 rounded-2xl border-zinc-200 bg-gradient-to-br from-white to-zinc-50 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md">
              <CardContent className="p-5">
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    <span className="text-sm font-medium text-zinc-500">Medical Notes</span>
                    <span className="flex h-10 w-10 items-center justify-center rounded-2xl bg-orange-100 text-orange-700">
                      <Activity className="h-4 w-4" />
                    </span>
                  </div>
                  <div className="text-3xl font-bold tracking-tight text-zinc-900">
                    {stats.withMedicalNotes}
                  </div>
            ...
            <Card className="col-span-2 md:col-span-2 rounded-2xl border-zinc-200 bg-gradient-to-br from-white to-zinc-50 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md">
              <CardContent className="p-5">
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    <span className="text-sm font-medium text-zinc-500">Quick Actions</span>
                    <span className="flex h-10 w-10 items-center justify-center rounded-2xl bg-red-100 text-red-700">
                      <Sparkles className="h-4 w-4" />
                    </span>
                  </div>
                  <div className="flex flex-wrap items-center gap-4 rounded-xl bg-zinc-50 p-3">
                    <div className="flex items-center space-x-2">
                      <Switch
                        checked={quickActions.showMedical}
                        onCheckedChange={(checked) =>
                          setQuickActions(prev => ({ ...prev, showMedical: checked }))
                        }
                        id="show-medical"
                      />
                      <Label htmlFor="show-medical" className="text-xs font-medium text-zinc-600">
                        Show Medical
                      </Label>
                    </div>
                    <div className="flex items-center space-x-2">
                      <Switch
                        ...
                        onCheckedChange={(checked) =>
                          setQuickActions(prev => ({ ...prev, groupByClass: checked }))
                        }
                        id="group-by-class"
                      />
                      <Label htmlFor="group-by-class" className="text-xs font-medium text-zinc-600">
                        Group by Class
                      </Label>
                    </div>
                  </div>
          ...
          <div className="space-y-4">
              ...
              <div className="flex flex-col gap-4 md:flex-row">
                <div className="flex-1 space-y-3">
                  <div className="relative">
                    ...
                    <Input
                      ...
                      className="h-11 rounded-xl border-zinc-200 bg-zinc-50 pl-10 focus:border-red-500 focus:ring-red-100"
                      value={searchTerm}
                  ...
                  <div className="flex flex-wrap items-center gap-2">
                    <Popover>
                      ...
                      <PopoverContent className="w-80 rounded-2xl border-zinc-200">
                        <div className="space-y-4">
                          <div className="space-y-2">
                          ...
                          <Button size="sm" onClick={() => setAdvancedSearch('')} variant="ghost" className="rounded-xl">
                ...
                <div className="flex flex-wrap gap-2">
                  <Button
                    ...
                    className="hidden rounded-xl border-zinc-200 md:flex"
                  >
                    ...
                    <DropdownMenuTrigger asChild>
                      <Button variant="outline" size="sm" className="rounded-xl border-zinc-200">
                        {viewMode === 'table' ? <List className="mr-2 h-4 w-4" /> :
                          viewMode === 'grid' ? <Grid className="mr-2 h-4 w-4" /> :
            ...
            {viewMode === 'table' ? (
                  ...
                  <Table>
                    <TableHeader className="bg-zinc-50">
                      <TableRow>
                        ...
                        {columnVisibility.id && (
                          <TableHead
                            className="cursor-pointer whitespace-nowrap hover:bg-zinc-100"
                        ...
                        {columnVisibility.class && <TableHead className="whitespace-nowrap">Class</TableHead>}
                        {columnVisibility.stream && <TableHead className="whitespace-nowrap">Stream</TableHead>}
                    ...
                    <TableBody>
                      {paginatedData.length > 0 ? (
                        paginatedData.map((student) => (
                          <TableRow key={student._id} className="group transition hover:bg-zinc-50">
                            <TableCell>
                              <input
                                type="checkbox"
                            ...
                            {columnVisibility.id && (
                              <TableCell>
                                <TooltipProvider>
                                  <Tooltip>
                                    <TooltipTrigger asChild>
                                      <Badge variant="outline" className="cursor-help rounded-full border-zinc-200 bg-zinc-50 font-mono">
                            ...
                            {columnVisibility.name && (
                              <TableCell>
                                <div className="flex items-center gap-3">
                                  <Avatar className="h-9 w-9 ring-1 ring-zinc-200">
                                  ...
                                  <div className="min-w-0">
                                    <div className="truncate font-medium text-zinc-900">
                                      {student.name?.first_name.toUpperCase()} {student.name?.last_name.toUpperCase()}
                                    </div>
                                  </div>
                                </div>
                              </TableCell>
                            ...
                            {columnVisibility.gender && (
                              <TableCell>
                                <span className="text-zinc-700">{student.gender}</span>
                              </TableCell>
                            )}
                            {columnVisibility.class && (
                              <TableCell>
                                <div className="space-y-1">
                                  <div className="font-medium text-zinc-800">{student.class?.name}</div>
                                </div>
                              </TableCell>
                            )}
                            ...
                            {columnVisibility.section && (
                              <TableCell>
                                <Badge className="rounded-full bg-zinc-100 text-zinc-800 hover:bg-zinc-100">
                                  {student.section}
                                </Badge>
                              </TableCell>
                            )}
                            {columnVisibility.age && (
                              <TableCell>
                                <div className="font-medium text-zinc-800">{calculateAge(student.date_of_birth)}</div>
                              </TableCell>
                            )}
                            {columnVisibility.status && (
                              <TableCell>
                                <Badge className={cn("rounded-full", getStatusColor(student.status))}>
                                  {student.status || 'active'}
                                </Badge>
                              </TableCell>
                            )}
                                  ...
                                  <Tooltip>
                                    <TooltipTrigger asChild>
                                      <div className="flex items-center gap-2">
                                        ...
                                        <Progress value={student.attendance_rate || 0} className="h-2 w-16 rounded-full" />
                                      </div>
                                    </TooltipTrigger>
                                    <TooltipContent>
                            ...
                            {columnVisibility.performance && (
                              <TableCell>
                                <div className={`rounded-lg px-2 py-1 text-center font-medium ${getPerformanceColor(student.performance_score || 0)}`}>
                                  {student.performance_score || 0}%
                                </div>
                              </TableCell>
                            )}
                            {columnVisibility.location && (
                              <TableCell>
                                <div className="min-w-0 space-y-1">
                                  <div className="truncate font-medium text-zinc-800">{student.residence?.district}</div>
                                  <div className="truncate text-xs text-zinc-500">{student.residence?.region}</div>
                                </div>
                              </TableCell>
                            )}
                            {columnVisibility.house && (
                              <TableCell>
                                {student.house ? (
                                  <Badge variant="outline" className="rounded-full">{student.house}</Badge>
                                ) : (
                            ...
                            <TableCell className="text-right">
                              <div className="flex justify-end gap-1">
                                <TooltipProvider>
                                  <Tooltip>
                                    <TooltipTrigger asChild>
                                      <Button onClick={() => router.push(`/admin/students/${student._id}`)} variant="ghost" size="icon" className="h-8 w-8 rounded-xl hover:bg-zinc-100">
                                ...
                                <TooltipProvider>
                                  <Tooltip>
                                    <TooltipTrigger asChild>
                                      <Button variant="ghost" size="icon" className="h-8 w-8 rounded-xl hover:bg-zinc-100">
                          ...
                          <TableCell colSpan={Object.values(columnVisibility).filter(v => v).length + 2} className="h-96 text-center">
                            {isLoading ? (
                              <div className="flex flex-col items-center justify-center gap-4">
                                <Settings className="h-12 w-12 animate-spin text-zinc-300" />
                                <div>
                                  <p className="text-lg font-medium text-zinc-500">Loading Students Data</p>
                              ...
                              <div className="flex flex-col items-center justify-center gap-4">
                                <AlertCircle className="h-12 w-12 text-zinc-300 animate-pulse" />
                                <div>
                                  <p className="text-lg font-medium text-zinc-500">No students found</p>
                                  <p className="text-sm text-zinc-400">
              ...
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                {paginatedData.map((student) => (
                  <Card key={student._id} className="overflow-hidden rounded-2xl border-zinc-200 bg-gradient-to-br from-white to-zinc-50 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md">
                    <CardContent className="p-4">
                      <div className="mb-4 flex items-start justify-between">
                        <Avatar className="h-12 w-12 ring-1 ring-zinc-200">
                          <AvatarImage src={student.photo} className='object-cover' />
                          <AvatarFallback className="bg-zinc-100">
                            {student.name?.first_name?.[0]}{student.name?.last_name?.[0]}
                          </AvatarFallback>
              ...
              <div className="space-y-2">
                {paginatedData.map((student) => (
                  <div key={student._id} className="flex items-center justify-between rounded-2xl border border-zinc-200 bg-white p-3 shadow-sm transition hover:bg-zinc-50">
            ...
            {filteredData.length > 0 && (
              <div className="flex flex-col items-center justify-between gap-4 rounded-2xl border border-zinc-200 bg-white px-4 py-4 shadow-sm sm:flex-row">
                <div className="flex items-center gap-2">
                  ...
                  >
                    <SelectTrigger className="w-[120px] rounded-xl border-zinc-200">
