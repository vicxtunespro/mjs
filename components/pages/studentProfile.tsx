...
// import { fetchGuardian } from '@/src/modules/guardian/guardian.repository';
...
//                     <Button onClick={() => router.push(`/admin/students/edit/${student._id}`)} className='bg-cta hover:bg-primary-plus hover:text-secondary'>
...
//                                     <Avatar className="min-h-28 min-w-24 rounded-md border-2 border-white shadow-xs">
//                                         <AvatarImage
//                                             src={student?.photo}
//                                             alt={`${student?.name?.first_name ?? ""} ${student?.name?.last_name ?? ""}`}
//                                             className="rounded-md object-cover"
//                                         />
//                                         <AvatarFallback className="rounded-md bg-gradient-to-br from-primary/10 to-cta/10 text-2xl">
...
//                                                 </Badge>
//                                                 <Badge variant="outline" className="border-secondary-minus text-secondary-minus">
//                                                     {student?.gender}
//                                                 </Badge>
//                                                 <Badge variant="outline" className="border-secondary-minus text-secondary-minus">
//                                                     {student?.section}
...
//                                             <div className="font-mono font-bold text-secondary text-xs">{student?.registration_id}</div>
//                                         </div>
//                                     </div>
//                                 </div>
...
//                     dark:data-[state=active]:bg-secondary
//                     data-[state=active]:text-seconadry
...
//                                         <span className="hidden sm:block">Academic</span>
//                                     </TabsTrigger>
//                                     <TabsTrigger value="guardians" className="
//                     flex items-center gap-2
//                     transition-all
//                     data-[state=active]:bg-primary
//                     dark:data-[state=active]:bg-secondary
...
//                                         <span className="hidden sm:block">Guardians</span>
//                                     </TabsTrigger>
//                                     <TabsTrigger value="medical" className="
//                     flex items-center gap-2
//                     transition-all
//                     data-[state=active]:bg-primary
//                     dark:data-[state=active]:bg-secondary
...
//                                                             <Avatar className="min-h-16 min-w-16 border-2 border-white shadow-xs">
//                                                                 <AvatarImage
//                                                                     src={guardian?.photo}
...
//                                                                         <span className="font-medium">{'guardian@gmail.com'}</span>
//                                                                     </div>
//                                                                 )}
//                                                             </div>
//                                                         </div>
...
//                                                                 <div className="font-semibold">{guardian.occupation || 'Business Person'}</div>
//                                                             </div>
//                                                         )}
//                                                         {guardian.workplace && (
//                                                             <div>
//                                                                 <div className="text-sm text-gray-500">Workplace</div>
//                                                                 <div className="font-semibold">{guardian.workplace || 'Office'}</div>
//                                                             </div>
//                                                         )}
//                                                     </CardContent>
//                                                     <CardFooter>
